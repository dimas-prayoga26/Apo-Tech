        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item mr-5">
                    <a class="nav-link active" aria-current="page" href="{{ route('home.index') }}" style="margin-right: 100px;"><i class="fas fa-home me-2"></i>Beranda</a>
                </li>
                <li class="nav-item mt-0" style="margin-top: 10px;">
                    <form class="d-flex">
                    <input style="width: 400px;" class="form-control me-3 w-100"  type="search" placeholder="Cari" aria-label="Cari" >
